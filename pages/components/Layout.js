...
function Layout() {
  return (
    <div className="container flex flex-wrap m-5 justify-center w-full">
        <Usercards title="Get a Ticket" goto="component/ticket" icon={<svg xmlns="http://www.w3.org/2000/svg" className=" w-16 mx-5 text-orange-500"fill="none" viewBox="0 0 24 24" stroke="currentColor">
